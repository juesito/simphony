...
//
//        try {
//            printerTmp = this.printerService.getPrinterRepository().findByDesc(this.printer.getDescription().trim());
//            if(printerTmp == null){
//                exist = false;
//            }
//        } catch (Exception ex) {
...
//        if (!exist) {
//            if (this.printer.getDescription() != null ) {
...
//            }
//        } else {
//            GrowlBean.simplyFatalMessage(mp.getValue("error_keyId"), this.printer.getDescription()+" "+mp.getValue("error_keyId_Detail"));
//        }
...
//    }
    ...
    public String update(User user) throws PersonException {
        ...
        this.printerService.getPrinterRepository().save(printerUpdated);
        GrowlBean.simplyInfoMessage(mp.getValue("msj_success"), this.printer.getDescription()+" "+mp.getValue("msj_record_update"));
        printer = new Printer();
        return toPrinter();
    }
